...
#
# Generated by export_simulation on Mon Jul 12 14:12:59 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Inst_mem_0.sh' script.

./Inst_mem_0.sh -reset_run
...
./Inst_mem_0.sh -noclean_files

For more information on the script, please type './Inst_mem_0.sh -help'.

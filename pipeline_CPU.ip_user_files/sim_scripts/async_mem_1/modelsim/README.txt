...
#
# Generated by export_simulation on Tue May 25 21:02:57 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './async_mem_1.sh' script.

./async_mem_1.sh -reset_run
...
./async_mem_1.sh -noclean_files

For more information on the script, please type './async_mem_1.sh -help'.

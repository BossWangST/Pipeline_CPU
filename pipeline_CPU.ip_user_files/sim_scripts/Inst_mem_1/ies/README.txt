...
#
# Generated by export_simulation on Tue Jun 01 22:00:25 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './Inst_mem_1.sh' script.

./Inst_mem_1.sh -reset_run
...
./Inst_mem_1.sh -noclean_files

For more information on the script, please type './Inst_mem_1.sh -help'.
